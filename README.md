...
> The complete application (HTML, CSS, and JavaScript) is contained within a single `index.html` file.
...
```bash
git clone https://github.com/priyaaa405/StayFinder.git
```

Open the project folder and simply launch `index.html` in your browser or use VS Code Live Server.
